...
import bgOut from "../../../assets/bg1.png"


const RightSideNav = () => {
    return (
      // Social login Button Section
      <div className="mb-10">
        <div className="p-5 space-y-3">
          <h2 className="text-xl font-bold">Login With</h2>
          <button className="btn btn-outline btn-info w-full border-2  border-sky-500">
            <FcGoogle className="text-xl"></FcGoogle>Login With Google
          </button>
          <button className="btn btn-outline w-full border-2">
        ...
        <div className="p-5">
          ...
          <a
            className="p-4 rounded-t-md border-2 flex items-center text-lg"
            href=""
          >
            <svg
              className="mr-3"
          ...
          <a className="p-4 border-x-2 flex items-center text-lg" href="">
            <svg
              className="mr-3"
              xmlns="http://www.w3.org/2000/svg"
              width="35"
          ...
          <a
            className="p-4 rounded-b-md border-2 flex items-center text-lg"
            href=""
          >
            <svg
              className="mr-3"
        ...
        {/* Kids zone Section */}
        <div className="p-5 space-y-3 bg-[#F3F3F3]">
          <h2 className="text-xl font-bold">Kids Zone</h2>
          <img src={KidsZone1} alt="" />
          <img src={KidsZone2} alt="" />
          <img src={KidsZone3} alt="" />
        </div>
        {/* Newspaper Banner */}
        <div className="pt-5">
          <div
          ...
          >
            ...
            <div className="hero-content text-center text-neutral-content">
              <div className="max-w-md">
                ...
                <button className="text-lg text-white rounded-sm w-[130px] h-[50px] bg-[#D72050]">
                  Learn More
                </button>
              </div>
            </div>
